  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" onClick="dashboard(${data.registerId})"><b>Maile.</b></a>
        <a class="navbar-brand brand-logo-mini" onClick="dashboard(${data.registerId})"><b>M</b>.</a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="data:image/jpeg;base64,${data.profileImageUploadPath}" alt="profile"/>
            </a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" onClick="dashboard(${data.registerId})">
	          ...
	          <li class="nav-item">
	            ...
	            <div class="collapse" id="ui-basic">
	              <ul class="nav flex-column sub-menu">
	                <li class="nav-item"> <a class="nav-link" onclick="showScreen('admin')">Add User</a></li>
	                <li class="nav-item"> <a class="nav-link" onclick="showScreen('admin')">Edit/Delete User</a></li>
	              </ul>
	            </div>
	          </li>
          	</c:when>
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Welcome ${data.name}</h3>
