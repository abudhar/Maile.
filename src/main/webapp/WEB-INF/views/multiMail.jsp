...
<section class="form-container">
  ...
  <form action="${pageContext.request.contextPath}/register" method="post" enctype="multipart/form-data" onsubmit="return validateFormData()" style="width: -webkit-fill-available;">
    ...
    <p>To whom the mail to be sent (Excel)<span>*</span></p>
    <input type="file" id="toAttachment" name="toAttachment"  class="box" style="width: 90% !important;" ><i class="fa fa-eye view-Excel" style="display: none;"></i>
...
<script>
  ...
  var fileInput = document.getElementById('toAttachment');
