...
public class Register {
	...
	public String toString() {
		return "Register [registerId=" + registerId + ", name=" + name + ", email=" + email + ", password=" + password
				+ ", userType=" + userType + ", status=" + status + ", profileImageUploadPath=" + profileImageUploadPath
